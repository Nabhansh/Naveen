...
export function Hero({ onOpenContact }: HeroProps) {
  ...
  return (
    <section
      ref={heroRef}
      className="relative min-h-[92svh] overflow-hidden bg-[#2a211c] text-[#f7f0e6]"
    >
      <motion.div style={{ y: heroY }} className="absolute inset-0">
        ...
        >
          {/* FIXED: actual file is in /public/video/, not /public/videos/ */}
          <source
            src="/video/hero-sanwariya.mp4"
            type="video/mp4"
          />
        </video>
        ...
        {!videoReady && !videoFailed && (
          <div
            className="absolute inset-0 z-[1] flex items-center justify-center bg-[#2a211c]/55"
            role="status"
            aria-live="polite"
          >
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto flex min-h-[92svh] max-w-[1280px] items-end px-6 pb-16 pt-32 sm:px-10 lg:px-16 lg:pb-24"
      >
        <div className="max-w-3xl">
          ...
          <motion.div
            ...
            className="mb-7 flex items-center gap-3 text-[10px] uppercase tracking-[0.28em] text-[#f0b08f]"
          >
          ...
          <motion.h1
            ...
            className="font-serif text-5xl leading-[0.94] tracking-[-0.045em] sm:text-7xl lg:text-[7.7rem]"
          >
            Give your walls
            <em className="block text-[#f0b08f]">
              a point of view.
            </em>
          </motion.h1>
          ...
          <motion.p
            ...
            className="mt-7 max-w-xl text-sm leading-7 text-[#f7f0e6]/80 sm:text-base"
          >
            <strong className="font-semibold text-[#fffaf2]">
              GIVE YOUR WALLS AND ROOMS A BETTER DESIGN AND LIFE WITH
              INTERIOR DESIGNING AND PANNELING....... Upgrade your house
              style with sanwariya seth interior and wallpapers
            </strong>
          </motion.p>
          ...
          >
            <Button
              ...
              className="h-12 rounded-none bg-[#c85a32] px-6 text-[11px] uppercase tracking-[0.2em] text-white transition-transform hover:-translate-y-0.5 hover:bg-[#d56c43] active:scale-[.98]"
            >
            ...
            <a
              ...
              className="inline-flex h-12 items-center gap-3 border border-[#f7f0e6]/35 px-5 text-[11px] uppercase tracking-[0.18em] text-[#f7f0e6] transition-colors hover:border-[#f0b08f] hover:text-[#f0b08f]"
            >
          ...
          <div className="mt-10 flex items-center gap-5 text-[10px] uppercase tracking-[0.18em] text-[#f7f0e6]/55">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 transition-colors hover:text-[#f0b08f]"
            >
